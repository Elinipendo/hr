...
{
$userid=$_GET['uid'];
$query=mysqli_query($link,"delete from employees where id='$userid'");
...
<td>
    <a href="edit_employee.php?id=<?php echo $row["id"]; ?>"><i class="icon-edit "></i></a><t>
<a href="employee.php?uid=<?php echo htmlentities($row['id']);?>&&action=del" title="Delete" onClick="return confirm('Do you really want to delete ?')">
