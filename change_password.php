...
{
$sql=mysqli_query($link,"SELECT password FROM  users where password='".md5($_POST['password'])."' && username='".$_SESSION['loggedin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $link=mysqli_query($link,"update users set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['loggedin']."'");
