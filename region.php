...
$sql=mysqli_query($con,"insert into department(name,supervisor,description) values('$name','$supervisor',$description')");
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="dashbord.php"><i class="menu-icon icon-dashboard"></i>Dashboard
                                </a></li>
                                <li><a href="#"><i class="menu-icon icon-bullhorn"></i>Department</a>
                                </li>
                             ...
                             <ul class="widget widget-menu unstyled">
                                <li><a class="collapsed" data-toggle="collapse" href="#togglePages"><i class="menu-icon icon-group">
                                    ...
                                    <ul id="togglePages" class="collapse unstyled">
                                        <li><a href="#"><i class="icon-plus"></i> Add New Employee </a></li>
                                        <li><a href="#"><i class="icon-group"></i> All Employees</a></li>
                                        
                                    </ul>
                                </li>
                                <li><a href="#"><i class="menu-icon icon-book"></i>Job Contracts</a></li>
                            </ul>

                            <ul class="widget widget-menu unstyled">
                                <li><a href="ui-button-icon.html"><i class="menu-icon icon-paste"></i> Regions </a></li>
...
<div class="controls">
<input type="text" placeholder="Enter Department Supervisor"  name="supervisor" class="span8 tip" required>
</div>
</div>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/hr/department.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
<button type="button" class="btn btn-primary">View Detials</button>
                                            </a>
<a href="employee.php?id=<?php echo htmlentities($row['id']);?>&&action=del" title="Delete" onClick="return confirm('Do you really want to delete ?')">
