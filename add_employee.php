...
{   
    ...
    $region=$_POST['region'];
    $title=$_POST['title'];
$sql=mysqli_query($link,"insert into employees(uni,firstname,lastname,middlename,gender,email,phone,nationality,department,dob,region,contract_type,title) values('$uni','$firstname','$middlename','$lastname','$gender','$email','$phone','$nationality','$department','$dob','$region','$contract','$title')");
                        ...
                        <div class="content">
                            ...
                            <div class="module-head">
                                    ...
                                    <div class="pull-right">
                                        <a href="upload/employees_upload/" class="btn btn-primary">ADD BULK</a>
                                    </div>
                                </div>
...
<div class="controls">
<input type="text" placeholder="Enter UNI"  name="uni" class="span4 tip" required>
</div>
</div> 
  <div class="control-group">
...
<div class="controls">
<input type="text" placeholder="Enter Firt Name"  name="firstname" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Middle Name</label>
<div class="controls">
<input type="text" placeholder="Enter Middle Name"  name="middlename" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="date"   name="dob" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="email" placeholder="Enter Email Address"  name="email" class="span8 tip" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Phone Number</label>
                                            <div class="controls">
                                                <input type="tel" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{3}-[0-9]{3}" placeholder="Eg. 255-758-000-999"  class="span8 tip" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
